...
function industrial_scripts() {
    ...
    */
    ...
    wp_enqueue_style( 'swiper-bundle', INDUSTRIAL_THEME_CSS_DIR . 'swiper-bundle.css', [] );
    wp_enqueue_style( 'magnific-popup', INDUSTRIAL_THEME_CSS_DIR . 'magnific-popup.css', [] );
    wp_enqueue_style( 'nice-select', INDUSTRIAL_THEME_CSS_DIR . 'nice-select.css', [] );
    ...
    wp_enqueue_script( 'waypoints', INDUSTRIAL_THEME_JS_DIR . 'waypoints.js', [ 'jquery' ], false, true );
    ...
    wp_enqueue_script( 'swiper-bundle', INDUSTRIAL_THEME_JS_DIR . 'swiper-bundle.js', [ 'jquery' ], false, true );
    wp_enqueue_script( 'owl-carousel', INDUSTRIAL_THEME_JS_DIR . 'owl-carousel.js', [ 'jquery' ], false, true );
    wp_enqueue_script( 'magnific-popup', INDUSTRIAL_THEME_JS_DIR . 'magnific-popup.js', [ 'jquery' ], '', true );
    wp_enqueue_script( 'parallax', INDUSTRIAL_THEME_JS_DIR . 'parallax.js', [ 'jquery' ], '', true );
    wp_enqueue_script( 'jquery-nice-select', INDUSTRIAL_THEME_JS_DIR . 'nice-select.js', [ 'jquery' ], '', true );
    wp_enqueue_script( 'wow', INDUSTRIAL_THEME_JS_DIR . 'wow.js', [ 'jquery' ], false, true );
